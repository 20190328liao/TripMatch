...
(function (window, $) {
    ...
    // 內容字串（使用你提供的條款文本）
    const privacyHtml = `
        <h3 class="titleWrap titleH1">想想 TripMatch 隱私權政策</h3>
        <p>歡迎您使用「想想 TripMatch 旅遊媒合平台」（以下簡稱「本服務」）。為了保障您的個人權益及隱私，本服務特此說明隱私權保護政策，請您詳閱：</p>
        <h3>一、 隱私權政策的適用範圍</h3>
        <p>本政策適用於您在使用本服務時，所涉及的個人資料蒐集、處理及利用。本服務可能包含第三方網站的連結（如航空公司、訂房平台），該類網站之隱私權保護由其自行負責，不適用本政策。</p>
        <h3>二、 個人資料的蒐集方式與內容</h3>
        <p>為了提供核心的「多人協作」與「旅遊媒合」功能，我們會蒐集以下資料：</p>
        <ol>
        ...
        <h3>八、 聯絡方式</h3>
        <p>若您對本政策有任何疑問，或欲行使個資權利，請聯繫：客服信箱：tripMatch@gmail.com。服務團隊：想想 TripMatch 開發團隊</p>
    `;

    const termsHtml = `
        <h3>想想 TripMatch 服務條款（Terms of Service）</h3>
        <p>歡迎您使用「想想 TripMatch 旅遊媒合平台」（以下簡稱「本平台」）。當您註冊帳號或開始使用本平台提供的服務（以下簡稱「本服務」）時，即表示您已閱讀、瞭解並同意接受本服務條款之所有內容。</p>
        <h3>一、 服務說明與定位</h3>
        <p>本平台提供多人旅遊協作工具，包含空檔比對、行程規劃、旅遊方案（機加酒）媒合建議及費用分帳計算。本平台定位為「資訊整合與決策支援工具」，非旅行社或票務代理商，不直接參與使用者與第三方服務商之間的交易。</p>
        <h3>二、 使用者帳號安全與行為規範</h3>
        <p>使用者應妥善保管帳號密碼，並遵守行為守則；違反者平台得刪除內容或終止帳號。</p>
        <h3>三、 第三方服務與媒合免責聲明</h3>
